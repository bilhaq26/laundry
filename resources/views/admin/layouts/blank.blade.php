...
<body class="d-flex align-items-center min-h-100">
    ...
    <header class="position-absolute top-0 start-0 end-0 mt-3 mx-3">
        <div class="d-flex d-lg-none justify-content-between">
            <a href="./index.html">
                <img class="w-100" src="{{ asset('admin_assets/svg/logos/logo_laundry.png') }}" alt="Image Description"
    ...
    <script src="{{ asset('admin_assets/vendor/hs-toggle-password/dist/js/hs-toggle-password.js') }}"></script>
