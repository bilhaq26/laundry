                            ...
                            <td class="table-column-ps-0">
                                <div class="ms-3">
                                    <span class="d-block h5 text-inherit mb-0">
                                        <a href="{{ route('admin.informasi.detail-pelanggan', $data->id) }}">{{ $data->konsumen->nama }}<a>
                                    </span>
                                </div>
                            </td>
                            <td class="text-center">
                                <span class="d-block h5 mb-0">{{ $data->getAllTotalLayanan() }}</span>
                            </td>
                            <td>Rp.{{ number_format($data->getAllTotalLayanan()*$data->total_bayar) }}</td>
                        </tr>
                        @empty
                        <tr>
