                ...
                <div class="col-lg-12 mb-3 mb-lg-0">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-header">
                            <h4 class="card-header-title">Edit Transaksi</h4>
                        </div>
                        <!-- End Header -->
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="tom-select-custom">
                                            <select disabled wire:model="konsumen_id" class="js-select form-select @error('konsumen_id')
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input wire:model.defer="tanggal_diterima" id="session-date" type="datetime-local"
                                                ...
                                                <div class="table-responsive">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @empty
                                                            <tr>
                                                                <td colspan="4" class="text-center">Tidak ada layanan</td>
                                                            </tr>
                                                            @endforelse
                                                        </tbody>
                                                    </table>
                    ...
                    <div class="modal-body">
                        <div class="col-md-12" wire:ignore>
                            <div class="form-group">
                                ...
                                <div>
                                    <select wire:model.defer="layanan_id" class="js-select form-select @error('layanan_id')
                                        is-invalid @enderror" autocomplete="off" data-hs-tom-select-options='{
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input wire:model.defer="nama" type="text" class="form-control" placeholder="Masukan Nama">
                            </div>
                            @error('berat')
                            <span class="text-danger">
                                {{ $message }}
