                                        ...
                                        <div class="col-sm-9">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <label class="avatar avatar-xl avatar-circle avatar-uploader me-5"
                                                    ...
                                                    @elseif ($photoPrev)
                                                        <img id="avatarImg" class="avatar-img" src="{{ asset('storage/images/user/small/' . Auth::user()->photo) }}"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control @error('email')
                                                is-invalid @enderror" name="email" id="emailLabel" wire:model.defer="email" placeholder="*Email">
                                        </div>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
